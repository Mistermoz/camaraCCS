		...
		<div class="content">
			...
			<div class="tabs"> 
			  <nav role='navigation' class="transformer-tabs">
			    <ul>
			      <li><a href="#tab-1" class="active">Productos</a></li>
			      <li><a href="#tab-2">DEMO</a></li>
			      <li><a href="#tab-3">¿Cuál es su valor?</a></li>
			      <li><a href="#tab-4">¿Cómo obtengo ésta presentación?</a></li>
			    </ul>
			  </nav>
